...
@NgModule({
  ...
  declarations: [PaidCoursesComponent, MisCursosComponent,ClassroomComponent,DepartmentDataComponent,InstitucionComponent,ScheduleComponent,SchoolPeriodComponent,ParticipantscrudComponent,AuthoritiesComponent],
})
